...
public class NotificationResponse {
    ...
    public NotificationResponse(List<PrivateNotification> privateNotifications, List<PublicNotification> publicNotifications, List<SystemNotification> systemNotifications) {
