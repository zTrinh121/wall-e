...
CREATE TABLE `t23_view_center_notification` (
  ...
  KEY `FKfftta0mp5wcuflb4okffap430` (`C23_HAS_SEEN_BY`),
  ...
  CONSTRAINT `FKfftta0mp5wcuflb4okffap430` FOREIGN KEY (`C23_HAS_SEEN_BY`) REFERENCES `t14_user` (`C14_USER_ID`)
