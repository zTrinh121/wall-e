...
ALTER TABLE `t02_slot`
  ...
  -- Step 1: Drop the foreign key constraints related to C08_COURSE_ID and C08_STUDENT_ID
ALTER TABLE t08_bill DROP FOREIGN KEY FK_BILL_COURSE;
ALTER TABLE t08_bill DROP FOREIGN KEY FK_BILL_STUDENT;

-- Step 2: Drop the columns C08_COURSE_ID and C08_STUDENT_ID
ALTER TABLE t08_bill DROP COLUMN C08_COURSE_ID;
ALTER TABLE t08_bill DROP COLUMN C08_STUDENT_ID;

ALTER TABLE `t06_feedback`
  DROP FOREIGN KEY `FK_T06_TO`,
  CHANGE `C06_SEND_TO_USER` `C06_SEND_TO_USER` int NOT NULL,
  ADD CONSTRAINT `FK_T06_COME` FOREIGN KEY (`C06_SEND_TO_USER`) REFERENCES `t14_user` (`C14_USER_ID`);
  
  ALTER TABLE `t06_feedback`
  ADD COLUMN `C06_RATING` int NOT NULL AFTER `C06_COURSE_ID`;
  
  ALTER TABLE `t06_feedback`
  DROP FOREIGN KEY `FK_T06_COURSE`,
  DROP KEY `FK_T06_COURSE`,
  DROP COLUMN `C06_COURSE_ID`;
