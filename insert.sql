...
INSERT INTO t21_center_posts (C21_TITLE, C21_CONTENT, C21_POST_STATUS, C21_FILE_URL, C21_CREATED_AT, C21_UPDATED_AT, C21_CENTER_ID) VALUES
('Classroom Change', 'Due to renovations, classes in Room 101 will be moved to Room 202.', 2, NULL, '2024-06-01 08:00:00', NULL, 1),
('Attendance System Upgrade', 'Our attendance system will be upgraded this weekend.', 2, NULL, '2024-06-02 09:00:00', NULL, 2),
('New Grading System', 'We are introducing a new grading system for the next semester.', 2, NULL, '2024-06-03 10:00:00', NULL, 3),
('Class Timing Adjustment', 'Class timings have been adjusted to better fit student schedules.', 2, NULL, '2024-06-04 11:00:00', NULL, 4),
('Library Schedule Change', 'The library will now be open from 8 AM to 8 PM.', 2, NULL, '2024-06-05 12:00:00', NULL, 5),
('New Attendance Policy', 'Please review our updated attendance policy.', 2, NULL, '2024-06-06 13:00:00', NULL, 6),
('Exam Room Change', 'The exam room for Math 101 has been changed to Room 303.', 2, NULL, '2024-06-07 14:00:00', NULL, 7),
('Student ID Cards', 'New student ID cards will be distributed next week.', 2, NULL, '2024-06-08 15:00:00', NULL, 8),
('Online Class Schedule', 'The online class schedule for the next term is now available.', 2, NULL, '2024-06-09 16:00:00', NULL, 9),
('New Student Portal', 'We are launching a new student portal for better access to resources.', 2, NULL, '2024-06-10 17:00:00', NULL, 10),
('Project Submission Guidelines', 'Please follow the new guidelines for project submissions.', 2, NULL, '2024-06-11 18:00:00', NULL, 11),
('Faculty Meeting', 'A faculty meeting is scheduled for next Monday.', 2, NULL, '2024-06-12 19:00:00', NULL, 12),
('Extra-Curricular Activities', 'Sign up for new extra-curricular activities available this semester.', 2, NULL, '2024-06-13 20:00:00', NULL, 13),
('Holiday Homework', 'Check the portal for holiday homework assignments.', 2, NULL, '2024-06-14 21:00:00', NULL, 14),
('New Textbooks', 'New textbooks are now available in the bookstore.', 2, NULL, '2024-06-15 22:00:00', NULL, 15),
('Health and Safety Guidelines', 'Review the updated health and safety guidelines for the campus.', 2, NULL, '2024-06-16 23:00:00', NULL, 16),
('E-Learning Tools', 'Explore new e-learning tools introduced for this term.', 2, NULL, '2024-06-17 08:00:00', NULL, 17),
('Campus Security Update', 'New security measures have been implemented on campus.', 2, NULL, '2024-06-18 09:00:00', NULL, 18),
('Student Counseling', 'Student counseling services are now available every weekday.', 2, NULL, '2024-06-19 10:00:00', NULL, 19),
('Lab Equipment Upgrade', 'The lab has been upgraded with new equipment.', 2, NULL, '2024-06-20 11:00:00', NULL, 20),
('New Cafeteria Menu', 'The cafeteria has introduced a new menu for the summer.', 2, NULL, '2024-06-21 12:00:00', NULL, 1),
('Class Participation Policy', 'Our class participation policy has been updated.', 2, NULL, '2024-06-22 13:00:00', NULL, 2),
('Exam Preparation Tips', 'Here are some tips to help you prepare for exams.', 2, NULL, '2024-06-23 14:00:00', NULL, 3),
('New Computer Lab', 'A new computer lab is now open for student use.', 2, NULL, '2024-06-24 15:00:00', NULL, 4)
